...
export default function DashboardLayout({ children }) {
    ...
    const navigation = useMemo(() => {
        const items = [
            ...
            { name: "Modèle", href: "/dashboard/card-templates", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414A1 1 0 0119 9.414V19a2 2 0 01-2 2z" },
            { name: "PDF", href: "/dashboard/pdf-templates", icon: "M7 3h7l5 5v13a2 2 0 01-2 2H7a2 2 0 01-2-2V5a2 2 0 012-2z M14 3v6h5 M8 14h8 M8 18h5" },
