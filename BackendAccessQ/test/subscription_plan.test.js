...
test("Pro applique 7 événements, 350 QR, 10 agents et 15 zones", () => {
  ...
  assert.equal(getQrQuotaStatus(summary, 349).allowed, true);
  assert.equal(getQrQuotaStatus(summary, 350).allowed, false);
